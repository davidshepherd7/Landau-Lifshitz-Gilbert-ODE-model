...
def constify_step(expr):
    dtnm1 = sympy.symbols('Delta1')
    dtn =  sympy.symbols('Delta0')
    return expr.subs([(dtnm1, dtn)])
...
def main():
    ...
    print ""
    print "================================================================"
    print full_x_coeffs[0][1].simplify()
    print
    print full_x_coeffs[0][1].simplify()
    print
    print full_x_coeffs[0][2].simplify()

    print "alskfjs"
    print "================================================================"
    print full_x_coeffs[1][1].simplify()
    print
    print full_x_coeffs[1][1].simplify()
    print
    print full_x_coeffs[1][2].simplify()

    print ""
    print "================================================================"
    print full_x_coeffs[2][1].simplify()
    print
    print full_x_coeffs[2][1].simplify()
    print
    print full_x_coeffs[2][2].simplify()
